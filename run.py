...
def run(argv):
	...
	parser.add_argument('--datapath', type=str, default='../../..//dataloader/dummy_switchboardcorpus',
	...
	parser.add_argument('--wvpath', type=str, default="../../..//wordvector/dummy_glove/300d",
